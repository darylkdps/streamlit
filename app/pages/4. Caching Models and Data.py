...
st.markdown(spacy.displacy.render(list(doc.sents)[0].as_doc(), style='dep', options={'add_lemma': True, 'compact': False, 'color': '#ffffff', bg: '#000000'}, jupyter=False), unsafe_allow_html=True)
